...
- `gen_banner.py` — per theme, renders a static `../banner-<theme>.png` (2400×986, ~2.43:1, 2× supersampled)
  and an animated `../banner-<theme>.gif` (1200×493) whose last prompt line types out rotating
